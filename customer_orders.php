...
$customer_user_id = isset($_GET['user_id']) ? intval($_GET['user_id']) : 0;
...
$customer_sql = "SELECT * FROM users_db WHERE id = ?";
$customer_stmt = $conn->prepare($customer_sql);
$customer_stmt->bind_param("i", $customer_user_id);
...
$orders_stmt->bind_param("i", $customer_user_id);
$orders_stmt->execute();
...
$stats_stmt->bind_param("i", $customer_user_id);
$stats_stmt->execute();
...
<html>
<head>
    <title>Customer Orders - <?php echo htmlspecialchars($customer['name']); ?> - Admin Dashboard</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p>View and manage orders for a specific customer.</p>
        </div>
        ...
        <div class="customer-info">
            ...
            <p><i class="fas fa-phone"></i> <?php echo htmlspecialchars($customer['no phone']); ?></p>
            <p><i class="fas fa-calendar"></i> Customer since: <?php echo isset($customer['created_at']) ? date('M d, Y', strtotime($customer['created_at'])) : 'N/A'; ?></p>
        </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn-status" onclick="updateOrderStatus(<?php echo $row['id']; ?>, '<?php echo $customer['email']; ?>', '<?php echo htmlspecialchars($customer['name']); ?>')">
                                            Update Status
                                        </button>
                                    </td>
                                </tr>
